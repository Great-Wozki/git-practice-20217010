...
*/
var PIECE_NUM = 7;
var bar = [[0, 0], [1, 0], [2, 0], [3, 0]];
var sevenShape = [[0, 0], [0, 1], [1, 1], [2, 1]];
var square = [[0, 0], [1, 0], [0, 1], [1, 1]]
/************************
    YOUR CODE STARTS
*************************/
var sevenShapeReversed = [[0, 1], [0, 0], [1 ,0], [2, 0]];
var hump = [[0, 0], [1, 0], [1, -1], [2, 0]];
var zShape = [[0, 0], [1, 0], [1, 1], [2, 1]];
var zShapeReversed = [[1, 0], [2, 0], [0, 1], [1, 1]];
/************************
    YOUR CODE ENDS
*************************/
...
function updateOccupationMatrix(piece) {
    ...
    for (var idx = 0; idx < piece.children.length; idx++) {
...
function fallToBottom(piece) {
    ...
    *************************/
    ...
    var across;
    var max = blockList[0];
    var maxvalue = max.rowPos;
    for(var i = 0; i < piece.children.length; i++)
    {
        block = blockList[i];
        if(block.rowPos > maxvalue)
        {
            maxvalue = block.rowPos;
        }
    }
        
    setPosition(piece, piece.rowPos + 19 - maxvalue, piece.colPos);
    updateOccupationMatrix(piece);
...
function isMoveDownValid(piece) {
    ...
    *************************/
    ...
    for(var i = 0; i < piece.children.length; i++)
    {
        ...
        list[i][0] = block.rowPos;
        list[i][1] = block.colPos;
        ...
        for(var j = 0; j < i; j++)
        {
            if(list[j][0] == block.rowPos - 1 && list[j][1] == block.colPos)
            {
                arr[j] = 0;
            }
        }
